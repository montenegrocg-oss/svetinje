...
await build({ absWorkingDir: adminDirectory, entryPoints: ["./client/editor.ts"], bundle: true, format: "esm", platform: "browser", target: "es2022", outfile: "public/assets/editor.js", minify: true, sourcemap: false, legalComments: "none" });
