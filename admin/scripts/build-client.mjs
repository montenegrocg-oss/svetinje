...
await build({ absWorkingDir: adminDirectory, entryPoints: ["./client/editor.ts", "./client/place-create.ts", "./client/route-editor.ts"], bundle: true, format: "esm", platform: "browser", target: "es2022", outdir: "public/assets", minify: true, sourcemap: false, legalComments: "none" });
