...
export const publicCopy = {
  sr: {
    ...
    homepage: {
      ...
      mapControls: { quickAria: "Брзи избор на карти", controls: "Контроле карте", layers: "Слојеви", layersTitle: "Слојеви карте", layersBody: "Основни Outdoor приказ је активан. Избор додатних картографских слојева биће доступан у каснијој фази.", zoom: "Зумирање карте", zoomIn: "Увећај карту", zoomOut: "Умањи карту", reset: "Прикажи поново Црну Гору", help: "Како користити карту?", helpTitle: "Интерактивна карта", helpBody: "Помјерајте и зумирајте карту, а филтерима изаберите врсту светиње. Приближите скуп ознака, отворите појединачну ознаку за прелазак на страницу мјеста и укључите доступне руте посебним филтером.", routeSummary: { distance: "Растојање", duration: "Вријеме", ascent: "Успон", difficulty: "Захтјевност", view: "Погледај руту", hours: "ч", minutes: "мин", difficulties: { easy: "Лака", moderate: "Средње захтјевна", demanding: "Захтјевна" } } },
    },
    pages: {
      catalogues: {
