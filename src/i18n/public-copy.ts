  ...
  sr: {
    ...
    pages: {
      ...
      placeDetail: {
        ...
        practical: { title: "Практичне информације", location: "Локација", address: "Адреса", type: "Тип", jurisdiction: "Епархија", feast: "Слава", coordinates: "Координате", copy: "Копирај координате", copied: "Координате су копиране.", copyFailed: "Координате није могуће копирати.", cathedralNote: "Координате означавају центар храмовног комплекса, а не тачан главни улаз.", placeNote: "Координате означавају центроид комплекса, а не тачан пјешачки улаз." },
  ...
  ru: {
    ...
    pages: {
      ...
      placeDetail: {
        ...
        practical: { title: "Практическая информация", location: "Местоположение", address: "Адрес", type: "Тип", jurisdiction: "Церковная юрисдикция", feast: "Престольный праздник", coordinates: "Координаты", copy: "Скопировать координаты", copied: "Координаты скопированы.", copyFailed: "Не удалось скопировать координаты.", cathedralNote: "Координаты указывают центр храмового комплекса, а не точный главный вход.", placeNote: "Координаты указывают центр комплекса, а не точный пешеходный вход." },
  ...
  en: {
    ...
    pages: {
      ...
      placeDetail: {
        ...
        practical: { title: "Practical information", location: "Location", address: "Address", type: "Type", jurisdiction: "Ecclesiastical jurisdiction", feast: "Patronal feast", coordinates: "Coordinates", copy: "Copy coordinates", copied: "Coordinates copied.", copyFailed: "Coordinates could not be copied.", cathedralNote: "The coordinates mark the centre of the cathedral complex, not the exact main entrance.", placeNote: "The coordinates mark the centre of the complex, not the exact pedestrian entrance." },
