...
export const publicCopy = {
  sr: {
    ...
    homepage: {
      ...
      mapControls: { quickAria: "Брзи избор на карти", controls: "Контроле карте", layers: "Слојеви", layersTitle: "Слојеви карте", layersBody: "Основни Outdoor приказ је активан. Избор додатних картографских слојева биће доступан у каснијој фази.", basemaps: { default: "Основна карта", topographic: "Топографска", satellite: "Сателит" }, zoom: "Зумирање карте", zoomIn: "Увећај карту", zoomOut: "Умањи карту", reset: "Прикажи поново Црну Гору", help: "Како користити карту?", helpTitle: "Интерактивна карта", helpBody: "Помјерајте и зумирајте карту, а филтерима изаберите врсту светиње. Приближите скуп ознака, отворите појединачну ознаку за прелазак на страницу мјеста и укључите доступне руте посебним филтером.", routeSummary: { distance: "Растојање", duration: "Вријеме", ascent: "Успон", difficulty: "Захтјевност", view: "Погледај руту", hours: "ч", minutes: "мин", difficulties: { easy: "Лака", moderate: "Средње захтјевна", demanding: "Захтјевна" } } },
    },
    pages: {
      catalogues: {
      ...
      map: { title: "Мапа — Светиње", description: "Интерактивна карта православних манастира и храмова у Црној Гори.", aria: "Интерактивна карта православних светиња", searchLabel: "Претрага светиња на карти", searchPlaceholder: "Претражите светиње…", shown: "Приказано на карти: {count}", help: { title: "Како користити карту", body: "Претрага и избор врсте скривају ознаке које не одговарају. Отворите ознаку за кратак приказ светиње. Круг са бројем означава групу блиских мјеста; активирајте га да приближите карту." } },
      ...
      calendar: { eyebrow: "Православни календар", title: "Православни календар — август–децембар 2026.", description: "Изаберите датум у доступном периоду за спомене дана и литургијско јеванђелско читање.", date: "Датум", open: "Отвори дан", pending: "Календар за {year}. годину је у припреми.", translationPending: "Преводи календарских читања су у припреми." },
      news: { title: "Новости", description: "Нови објекти у каталогу, њихове измјене и обавјештења о пројекту.", allNews: "Све новости", shown: "Приказано је {count} новости.", empty: "Нема новости за изабрани период и категорију.", filters: "Филтери", categories: "Категорије", allCategories: "Све категорије", archive: "Архива", allPeriods: "Сви периоди", reset: "Поништи филтере", paginationAria: "Странице новости", previous: "Претходна", next: "Сљедећа", page: "Страница", pageOf: "Страница {current} од {total}", placeAddedTitle: "Додато у каталог: {name}", types: { "place-added": "НОВИ ОБЈЕКАТ", "place-updated": "АЖУРИРАНО", "site-update": "САЈТ", announcement: "ОБАВЈЕШТЕЊЕ", news: "НОВОСТ" } },
      ...
      placeDetail: {
        breadcrumbs: "Путања странице", home: "Почетна", facts: "Основни подаци", actions: "Радње за посјету", addFavorite: "Додај у омиљено", removeFavorite: "Уклони из омиљеног",
        about: { monastery: "О манастиру", church: "О цркви", other: "О светињи", empty: "Општи подаци о светињи су у припреми." },
        gallery: { title: "Фотографије", enlarge: "Увећај фотографију", video: "Видео", videoTitle: "Видео", videoPrompt: "YouTube видео се учитава тек када га покренете.", playVideo: "Покрени видео", aria: "Галерија", close: "Затвори галерију", previous: "Претходна фотографија", next: "Следећа фотографија" },
  ...
  ru: {
    ...
    homepage: {
      ...
      mapControls: { quickAria: "Быстрый выбор на карте", controls: "Управление картой", layers: "Слои", layersTitle: "Слои карты", layersBody: "Активен базовый слой Outdoor. Дополнительные слои появятся позже.", basemaps: { default: "Основная карта", topographic: "Топографическая", satellite: "Спутник" }, zoom: "Масштаб карты", zoomIn: "Увеличить", zoomOut: "Уменьшить", reset: "Показать Черногорию", help: "Как пользоваться картой?", helpTitle: "Интерактивная карта", helpBody: "Перемещайте и масштабируйте карту, а фильтрами выбирайте тип святыни. Приблизьте группу меток, откройте отдельную метку для перехода к странице места и включите доступные маршруты отдельным фильтром.", routeSummary: { distance: "Расстояние", duration: "Время", ascent: "Подъём", difficulty: "Сложность", view: "Посмотреть маршрут", hours: "ч", minutes: "мин", difficulties: { easy: "Лёгкий", moderate: "Средней сложности", demanding: "Сложный" } } },
    },
    pages: {
      catalogues: {
      ...
      map: { title: "Карта святынь", description: "Интерактивная карта православных монастырей и храмов Черногории.", aria: "Интерактивная карта православных святынь", searchLabel: "Поиск святынь на карте", searchPlaceholder: "Найти святыню…", shown: "Показано на карте: {count}", help: { title: "Как пользоваться картой", body: "Поиск и выбор категории скрывают неподходящие метки. Откройте метку, чтобы увидеть краткую информацию о святыне. Круг с числом обозначает группу близких мест; активируйте его, чтобы приблизить карту." } },
      ...
      calendar: { eyebrow: "Православный календарь", title: "Православный календарь — август–декабрь 2026", description: "Выберите дату в доступном периоде, чтобы открыть памятования дня и литургическое евангельское чтение.", date: "Дата", open: "Открыть день", pending: "Календарь на {year} год готовится.", translationPending: "Переводы календарских чтений готовятся." },
      news: { title: "Новости", description: "Новые объекты каталога, их обновления и объявления о проекте.", allNews: "Все новости", shown: "Показано новостей: {count}.", empty: "Нет новостей за выбранный период и категорию.", filters: "Фильтры", categories: "Категории", allCategories: "Все категории", archive: "Архив", allPeriods: "Все периоды", reset: "Сбросить фильтры", paginationAria: "Страницы новостей", previous: "Предыдущая", next: "Следующая", page: "Страница", pageOf: "Страница {current} из {total}", placeAddedTitle: "Добавлено в каталог: {name}", types: { "place-added": "НОВЫЙ ОБЪЕКТ", "place-updated": "ОБНОВЛЕНО", "site-update": "САЙТ", announcement: "ОБЪЯВЛЕНИЕ", news: "НОВОСТЬ" } },
      ...
      placeDetail: {
        breadcrumbs: "Навигационная цепочка", home: "Главная", facts: "Основные сведения", actions: "Действия для посещения", addFavorite: "Добавить в избранное", removeFavorite: "Удалить из избранного",
        about: { monastery: "О монастыре", church: "О храме", other: "О святыне", empty: "Общие сведения о святыне готовятся." },
        gallery: { title: "Фотографии", enlarge: "Увеличить фотографию", video: "Видео", videoTitle: "Видео", videoPrompt: "Видео с YouTube загружается только после запуска.", playVideo: "Запустить видео", aria: "Галерея", close: "Закрыть галерею", previous: "Предыдущая фотография", next: "Следующая фотография" },
  ...
  en: {
    ...
    homepage: {
      ...
      mapControls: { quickAria: "Quick map filters", controls: "Map controls", layers: "Layers", layersTitle: "Map layers", layersBody: "The Outdoor base layer is active. Additional layers will be available later.", basemaps: { default: "Default map", topographic: "Topographic", satellite: "Satellite" }, zoom: "Map zoom", zoomIn: "Zoom in", zoomOut: "Zoom out", reset: "Show Montenegro", help: "How to use the map", helpTitle: "Interactive map", helpBody: "Pan and zoom the map, and use the filters to choose a holy-place type. Zoom into a marker cluster, open a marker to visit the place page, and use the separate filter to show available routes.", routeSummary: { distance: "Distance", duration: "Time", ascent: "Ascent", difficulty: "Difficulty", view: "View route", hours: "hr", minutes: "min", difficulties: { easy: "Easy", moderate: "Moderate", demanding: "Demanding" } } },
    },
    pages: {
      catalogues: {
      ...
      map: { title: "Map of holy places", description: "An interactive map of Montenegro's Orthodox monasteries and churches.", aria: "Interactive map of Orthodox holy places", searchLabel: "Search holy places on the map", searchPlaceholder: "Search holy places…", shown: "Shown on the map: {count}", help: { title: "How to use the map", body: "Search and category filters hide markers that do not match. Open a marker for a short place preview. A numbered circle represents nearby places; activate it to zoom in." } },
      ...
      calendar: { eyebrow: "Orthodox calendar", title: "Orthodox calendar — August–December 2026", description: "Choose a date in the available period to open the day's commemorations and liturgical Gospel reading.", date: "Date", open: "Open day", pending: "The calendar for {year} is being prepared.", translationPending: "Translated calendar readings are being prepared." },
      news: { title: "News", description: "New catalogue entries, place updates, and notices about the project.", allNews: "All news", shown: "Showing {count} news items.", empty: "No news matches the selected period and category.", filters: "Filters", categories: "Categories", allCategories: "All categories", archive: "Archive", allPeriods: "All periods", reset: "Reset filters", paginationAria: "News pages", previous: "Previous", next: "Next", page: "Page", pageOf: "Page {current} of {total}", placeAddedTitle: "Added to the catalogue: {name}", types: { "place-added": "NEW PLACE", "place-updated": "UPDATED", "site-update": "SITE", announcement: "ANNOUNCEMENT", news: "NEWS" } },
      ...
      placeDetail: {
        breadcrumbs: "Breadcrumbs", home: "Home", facts: "Essential information", actions: "Visit actions", addFavorite: "Add to favourites", removeFavorite: "Remove from favourites",
        ...
        gallery: { title: "Photographs", enlarge: "Enlarge photograph", video: "Video", videoTitle: "Video", videoPrompt: "The YouTube video loads only after you start it.", playVideo: "Play video", aria: "Gallery", close: "Close gallery", previous: "Previous photograph", next: "Next photograph" },
